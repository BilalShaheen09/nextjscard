            ...
            <div className="flex grow items-center justify-center p-6">
                <div className="bg-slate-200 p-6 rounded-lg shadow-lg max-w-2xl w-full flex items-center justify-center border-4 border-sky-300">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-0">
                        <div className="relative h-full w-full max-w-[450px] max-h-[390px]">
                            <Image 
                            src="/background2.png"
                    ...
                    <div className="w-2/3 pr-4 pt-16 relative z-10">
                        ...
                        <p className="mb-2">
                            ...
                            <span className="text-black font-bold">Bilal Shaheen</span>
                        </p>
                        <p className="mb-2">
                            <span className="text-sky-500">{""}<strong>Roll No: </strong></span>
                            <span className="text-black font-bold">00039323</span>
                        </p>
                        <p className="mb-2">
                    ...
                    <div className="w-1/3 text-center relative z-10">
                        <Image src="/bgp.png" alt="profile image" width={800} height={800} className=" border rounded-lg mb-6 w-full h-auto " />
